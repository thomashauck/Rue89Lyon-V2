...
<rss xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:wfw="http://wellformedweb.org/CommentAPI/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:atom="http://www.w3.org/2005/Atom" xmlns:sy="http://purl.org/rss/1.0/modules/syndication/" xmlns:slash="http://purl.org/rss/1.0/modules/slash/" version="2.0">
    <channel>
        <title>Rue89 Strasbourg</title>
        <atom:link href="http://www.rue8sbourg.com/9strasbourg.com/index.php/mailchimprss/" rel="self" type="application/rss+xml"/>
        <link>http://www.rue89stra</link>
        ...
        <?php if ($wp_query->have_posts()) : ?>
            ...
            <?php while ( have_posts() ) : the_post();
						...
						$image_attributes = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID),'rss-thumb-446');
